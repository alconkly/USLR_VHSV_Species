...
### 3. Pairwise median titer- Kruskal-Wallis test with Dunn post-hoc comparisons with Bonferroni correction between host species
```{r, echo=FALSE}
...
### 4. Figure: prevalence barplots between host species
```{r, echo=FALSE}
...
### 4. Figure: Titer boxplots between host species
