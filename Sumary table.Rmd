...
```{r}
VHSVCollection_1<-read_xlsx("C:/Users/ah2355/Documents/GitHub/USLR_VHSV_Species/CollectionSummary_1.xlsx") 

(VHSV_Table<- gt(VHSVCollection_1, groupname_col = 'Location', rowname_col = 'Bay') %>%  
              sub_missing(columns = everything(), missing_text = "") %>%
  cols_width( "Collection Dates" ~ px(85), Bay~px(50), everything() ~ px(25))  %>% cols_align(align = 'center', columns = everything()) %>% tab_options(table.font.size = px(10) )) 


VHSV_Table %>% gtsave(filename="VHSV_Species.docx", path="C:/Users/ah2355/Documents/GitHub/USLR_VHSV_Species/Figures" )
